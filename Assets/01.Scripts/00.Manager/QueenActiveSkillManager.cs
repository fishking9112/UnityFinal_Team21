...
public class QueenActiveSkillManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Utils.DelayedTimeAction(() =>
        {
            ...
            //GameManager.Instance.queen.controller.queenActiveSkillSlot.AddSlot(4, queenActiveSkillDic[(int)IDQueenActiveSkill.SKELETON_LEGION]);
            //GameManager.Instance.queen.controller.queenActiveSkillSlot.AddSlot(5, queenActiveSkillDic[(int)IDQueenActiveSkill.DEATH_SYMBOL]);
            ...
            //GameManager.Instance.queen.controller.queenActiveSkillSlot.AddSlot(5, queenActiveSkillDic[(int)IDQueenActiveSkill.SUMMON_ZOMBIE]);
        }, 3);
    }
