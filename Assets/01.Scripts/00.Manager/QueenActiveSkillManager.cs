...
public class QueenActiveSkillManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            GameManager.Instance.queen.controller.queenActiveSkillSlot.AddSlot(0, queenActiveSkillDic[(int)IDQueenActiveSkill.SKELETONLEGION]);
            ...
            GameManager.Instance.queen.controller.queenActiveSkillSlot.AddSlot(5, queenActiveSkillDic[(int)IDQueenActiveSkill.ZOMBIESUMMON]);
        }, 3);
    }
